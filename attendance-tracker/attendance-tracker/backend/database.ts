...
import { DatabaseProfiler } from './utils/databaseProfiler';

const db: Database.Database = new Database(path.join(__dirname, 'attendance.db'));
...
const profiler = new DatabaseProfiler(db);
